...
describe('encode', () => {
  describe('absolute URLs', () => {
    ...
    test('host (special characters)', () => {
      ...
      expect(result).toBe(`protocol://${encodeURIComponent('你好/世界')}`)
    })

    test('pathname', () => {
      const url = 'protocol://foo/你好世界'

      const result = encode(url)

      expect(result).toBe(`protocol://foo/${encodeURIComponent('你好世界')}`)
    })
    ...
    test('pathname (special characters)', () => {
      ...
      expect(result).toBe(`protocol://foo/${encodeURIComponent('你好/世界')}`)
    })

    test('querystring', () => {
      const url = 'protocol://foo/?你好=世界'

      const result = encode(url)

      expect(result).toBe(`protocol://foo/?${encodeURIComponent('你好')}=${encodeURIComponent('世界')}`)
    })
    ...
    test('querystring (special characters)', () => {
      ...
      expect(result).toBe(`protocol://foo/?${encodeURIComponent('你/好')}=${encodeURIComponent('世/界')}`)
    })
  ...
  describe('relative URLs', () => {
    ...
    test('pathname (special characters)', () => {
      ...
      expect(result).toBe(`../${encodeURIComponent('你好/世界')}`)
    })
    ...
    test('querystring', () => {
      ...
      expect(result).toBe(`../?${encodeURIComponent('你好')}=${encodeURIComponent('世界')}`)
    })
    ...
    test('querystring (special characters)', () => {
      ...
      expect(result).toBe(`../?${encodeURIComponent('你/好')}=${encodeURIComponent('世/界')}`)
    })
